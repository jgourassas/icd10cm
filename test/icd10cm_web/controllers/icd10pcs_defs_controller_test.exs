defmodule Icd10cmWeb.Icd10pcs_defsControllerTest do
  ...
  @create_attrs %{axis_code: "some axis_code", axis_title: "some axis_title", section: "some section", section_title: "some section_title", term_definition: "some term_definition", term_explanation: "some term_explanation", term_includes: "some term_includes", term_titles: "some term_titles", terms: "some terms", title_tsv: "some title_tsv"}
  ...
  describe "edit icd10pcs_defs" do
    ...
    test "renders form for editing chosen icd10pcs_defs", %{conn: conn, icd10pcs_defs: icd10pcs_defs} do
  ...
  describe "update icd10pcs_defs" do
    ...
    test "redirects when data is valid", %{conn: conn, icd10pcs_defs: icd10pcs_defs} do
      conn = put(conn, Routes.icd10pcs_defs_path(conn, :update, icd10pcs_defs), icd10pcs_defs: @update_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn, icd10pcs_defs: icd10pcs_defs} do
      conn = put(conn, Routes.icd10pcs_defs_path(conn, :update, icd10pcs_defs), icd10pcs_defs: @invalid_attrs)
      assert html_response(conn, 200) =~ "Edit Icd10pcs defs"
    end
  end
