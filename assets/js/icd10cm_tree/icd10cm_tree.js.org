...
class Draw {
  ...
  /////////////////////////
  test(tree_data) {
    let tree_origin_x = width * 0.05;
    let tree_origin_y = height * 0.09;
     let source = tree_data;



  //  let svg_dot = d3.select("#anchor_svg").append("g")
    ...
    nodeEnter.append("text")
      ...
      .on("click", (d, i) => {
       // d.children = d.children ? null : d._children
         ...
         //console.log("clicked ---------------------" +  JSON.stringify(d.data.name) );
...
.attr("transform", (d) =>  { 
 ...
 // console.log("node d.y" + d.y)
   return "translate(" + d.y + "," + d.x + ")"; })
.style("opacity", 1)
.select("rect")
.style("fill", icd10cm_desc_color);

// Transition exiting icd10cm_nodes to the parent's new position.
 
//d3.select( (d) => {".node" + d.id}).exit().transition()
...
nodes.each(function(d) {
  ...
  //  var  tree = d3.layout.tree().nodeSize([70, 40]);
    ...
    */
    ...
    nodeEnter
      .append("path")
      .attr("d", symbol)
      .style("fill", d => d.children ? "red" : "yellow")
      .style("cursor", "pointer")
      .attr("pointer-events", "all")
      .on("click", (d, i) => {
        // console.log("clicked ---------------------" +  JSON.stringify(d.data["name"]) )
  ...
  icd10cm_2(group, treeData) {
    ...
    /******************************
     * Alternative 
     * load data/diagnosis.json
     * let nested_data = d3.nest()
     *                   .key(d = d.icd10cm_code_2 )
     *                   .entries(treeData)
     * 
    ...
    svg.append("g")
      ...
      //.attr("cx", d => d.x)
      //.attr("cy", d => d.y)
      .attr("fill", d => d.children ? "#fff" : "cyan")
      .attr("r", 2.5);
    ////////////////////////////////////////////
    ...
    const node = g.append("g")
      ...
      .join("g")
      //.attr("transform", d => `translate(${d.y},${d.x})`);
      .attr("transform", d => `translate(${d.y},${d.x * 0.02})`);
